...
| **Information-rich** | Rewards precision, producing a genuine [density signal](docs/probability-map.md) |
...
The system starts with crypto price forecasting and expands to [sports, politics, finance, and technology](docs/markets.md).
