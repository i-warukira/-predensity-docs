...
The prediction chart that emerges from Predensity's activity is a real-time, crowd-sourced view of where the market thinks prices are heading. It aggregates bets from participants with different knowledge, models, and risk tolerances.
